...
CREATE TABLE `saran` (
  ...
  `saran_name` text NOT NULL,
  `saran_category` text NOT NULL,
...
ALTER TABLE `saran`
  MODIFY `saran_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;

-- KEUANGANNNNNNNNNNNNNN

CREATE TABLE `uang` (
  `uang_id` int(11) NOT NULL,
  `uang_pengirim` text NOT NULL,
  `uang_pesan` text NOT NULL,
  `uang_nominal` text NOT NULL,
  `uang_total` text NOT NULL,
